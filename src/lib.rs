            ...
            for layer in 0..CS {
                ...
                for forward in 0..CS {
                    ...
                    while bits_here != 0 {
                        ...
                        let v_type = voxels
                            [get_axis_index::<CS>(axis, forward + 1, bit_pos + 1, layer + 1)]
                            as usize;
            ...
            for forward in 0..CS {
                ...
                for right in 0..CS {
                    ...
                    while bits_here != 0 {
                        ...
                        let v_type =
                            voxels[get_axis_index::<CS>(axis, right + 1, forward + 1, bit_pos)] as usize;
                ...
                for forward in 0..CS {
                    ...
                    while bits_here != 0 {
                        ...
                        if (bits_next >> bit_pos & 1) != 0
                            && v_type
                                == voxels[get_axis_index::<CS>(axis, forward + 2, bit_pos + 1, layer + 1)]
                        {
                        ...
                        for right in (bit_pos + 1)..CS {
                            if (bits_here >> right & 1) == 0
                                ...
                                || v_type
                                    != voxels
                                        [get_axis_index::<CS>(axis, forward + 1, right + 1, layer + 1)]
                            {
                                break;
                            }
                ...
                for right in 0..CS {
                    ...
                    while bits_here != 0 {
                        ...
                        if *right_merged_ref == 0
                            ...
                            && v_type
                                == voxels[get_axis_index::<CS>(axis, right + 1, forward + 2, bit_pos)]
                        {
                        ...
                        if (bits_right >> bit_pos & 1) != 0
                            ...
                            && v_type
                                == voxels[get_axis_index::<CS>(axis, right + 2, forward + 1, bit_pos)]
                        {
